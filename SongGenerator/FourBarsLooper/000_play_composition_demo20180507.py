...
if __name__ == '__main__':
    #load lead sheet
    leadSheet = ls.composition_demo20180507()
    ...
    mDr = np.stack([mHH, mSn ,bDr], axis = -1)
    ...
    sp_melody =  mltPrcss.ChildProcess(device, 0, 1, pointer_Harm, currentBeat, melody, mel_articulation, timeSeriesObj, playFlg_mel, goFlg)
    sp_cMelody =  mltPrcss.ChildProcess(device, 3, 5, pointer_Harm, currentBeat, cMelody, cMel_articuration, timeSeriesObj, playFlg_mel, goFlg) #playFlg_cMel
